...
function ModalDetailRepair({ selectedReport }) {
  const [nameFacility, setNameFacility] = useState('');
  const [day, setDay] = useState('');
  const [nameField, setNameField] = useState('');
  const [quantity, setQuantity] = useState('');
  const [price, setPrice] = useState('');
  const [dayRepair, setDayRepair] = useState('');
  ...
  useEffect(() => {
    if (selectedReport) {
      ...
      setDayRepair(selectedReport.dayRepair);
  ...
  return (
    <div
      ...
      id="detailrepair"
      tabIndex="-1"
      aria-labelledby="detailrepairLabel"
      aria-hidden="true"
    >
      <div className="modal-dialog" style={{ maxWidth: '60%' }}>
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="detailrepairLabel">
              Detail Repair
            </h5>
            <button
              type="button"
...
export default ModalDetailRepair;
